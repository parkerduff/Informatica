-- T-SQL stub for Oracle stored procedure updt_orig_cancelled_trans01_p.
...
IF OBJECT_ID('dbo.updt_orig_cancelled_trans01_p', 'P') IS NOT NULL DROP PROCEDURE dbo.updt_orig_cancelled_trans01_p;
GO
CREATE PROCEDURE dbo.updt_orig_cancelled_trans01_p
AS
BEGIN
    SET NOCOUNT ON;
    RAISERROR('STUB: Extract Oracle source and implement dbo.updt_orig_cancelled_trans01_p.', 10, 1) WITH NOWAIT;
END;
GO

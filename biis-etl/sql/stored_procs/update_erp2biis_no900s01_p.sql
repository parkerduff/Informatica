-- T-SQL stub for Oracle stored procedure update_erp2biis_no900s01_p.
...
BEGIN
    SET NOCOUNT ON;
    RAISERROR('STUB: Extract Oracle source and implement dbo.update_erp2biis_no900s01_p.', 10, 1) WITH NOWAIT;
END;
GO

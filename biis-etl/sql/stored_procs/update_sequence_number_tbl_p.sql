-- T-SQL stub for Oracle stored procedure update_sequence_number_tbl_p.
...
IF OBJECT_ID('dbo.update_sequence_number_tbl_p', 'P') IS NOT NULL DROP PROCEDURE dbo.update_sequence_number_tbl_p;
GO
CREATE PROCEDURE dbo.update_sequence_number_tbl_p
AS
BEGIN
    SET NOCOUNT ON;
    RAISERROR('STUB: Extract Oracle source and implement dbo.update_sequence_number_tbl_p.', 10, 1) WITH NOWAIT;
END;
GO

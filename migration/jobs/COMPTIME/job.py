#!/usr/bin/env python3
"""
Converted Glue job for PowerCenter folder ``COMPTIME``.

Classification : python_shell
Primary mapping: m_COMPTIME_Load_COMP_TIME_DAILY_TBL
Primary source : U0287D01
Primary target : COMP_TIME_DAILY_TBL

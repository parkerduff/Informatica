#!/usr/bin/env python3
"""
Converted Glue job for PowerCenter folder ``Pseudossn``.

Classification : pyspark
Primary mapping: m_Pseudossn_Load_Pseudossn_Tbl
Primary source : PSEUDOSSN_FILE
Primary target : PSEUDOSSN_TBL
